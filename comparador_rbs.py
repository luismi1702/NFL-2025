...
ax.plot(angles, v1_radar, color=RB1_COLOR, linewidth=2.2, zorder=4, label=rb1_name)
ax.fill(angles, v1_radar, color=RB1_COLOR, alpha=0.20, zorder=3)

ax.plot(angles, v2_radar, color=RB2_COLOR, linewidth=2.2, zorder=4, label=rb2_name)
...
outfile = f"comparador_{safe_rb1}_{safe_rb2}_{SEASON}.png"
