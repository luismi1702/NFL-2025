...
team1 = _equipo(te1_name)
team2 = _equipo(te2_name)
...
ax.plot(angles, v1_radar, color=TE1_COLOR, linewidth=2.2, zorder=4, label=f"{te1_name} ({team1})")
ax.fill(angles, v1_radar, color=TE1_COLOR, alpha=0.20, zorder=3)

ax.plot(angles, v2_radar, color=TE2_COLOR, linewidth=2.2, zorder=4, label=f"{te2_name} ({team2})")
...
outfile = salida(f"comparador_{safe_te1}_{safe_te2}_{SEASON}.png", SEASON)
