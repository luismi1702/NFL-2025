...
try:
    ...
    raise SystemExit(
        ...
        f"  {e}\n"
        "  Este visual necesita datos de participacion (el personal defensivo del rival),\n"
        "  que nflverse publica mas tarde que el play-by-play.\n")
part = part[["nflverse_game_id", "play_id", "defense_personnel"]]
...
outfile = salida(f"ataque_vs_personal_defensivo_{SEASON}.png", SEASON)
