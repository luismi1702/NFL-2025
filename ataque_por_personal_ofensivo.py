"""
ataque_por_personal_ofensivo.py
...
try:
    ...
    raise SystemExit(
        ...
        f"  {e}\n"
        "  Este visual necesita datos de participacion (los paquetes de personal ofensivo),\n"
...
outfile = salida(f"ataque_por_personal_ofensivo_{SEASON}.png", SEASON)
