...
- salida() archiva en salidas/{a�o}/w{semana}/ y estampa _wNN en el nombre
...
- Hilos de la f�rmula del campe�n (dos �ngulos, ambos verificados): docs/hilo_formula_campeon.md (retrospectivo) y docs/hilo_deberes_2026.md (prescriptivo, 31 tuits, pendiente de publicar)
